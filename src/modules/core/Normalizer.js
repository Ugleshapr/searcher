...
this.homoglyphCanon = new Map([
  // Латиница (простые соответствия)
  ['a','a'], ['b','b'], ['c','c'], ['d','d'], ['e','e'], ['f','f'], ['h','h'],
  ['k','k'], ['m','m'], ['o','o'], ['p','p'], ['r','p'], ['t','t'],
  ['x','x'], ['y','y'],

  // Кириллица → латинский канон
  ['а','a'], ['в','b'], ['д','d'], ['е','e'], ['н','h'], ['л','l'], ['к','k'],
  ['м','m'], ['о','o'], ['р','p'], ['т','t'], ['х','x'], ['у','y'], ['ф','f'],

  //кириллическая «с» / «С» → канон 's'
  ['с','s'],   
  ['С','s'],   
  ['б','b'],
  ['Б','b'],
  ...
  ['A','a'], ['B','b'], ['C','c'], ['D','d'], ['E','e'], ['F','f'], ['H','h'],
  ['K','k'], ['M','m'], ['O','o'], ['P','p'], ['R','p'], ['T','t'], ['X','x'], ['Y','y'],
  ...
  ['М','m'], ['О','o'], ['Р','p'], ['Т','t'], ['Х','x'], ['У','y'], ['Ф','f']
    ...
    this.homoglyphClass = new Map([
      ...
      ['h','[hн]'],['k','[kк]'],['m','[mм]'],['o','[oо]'],
      ['p','[prр]'],['r','[prр]'],['t','[tт]'],['x','[xх]'],['y','[yу]'],['f','[fф]'],['s','[sScCсС]'],['S','[sScCсС]'], ['b','[bBбБ]'],['B','[bBбБ]'],
